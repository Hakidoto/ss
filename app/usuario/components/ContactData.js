  ...
  return (
    <div className={`${style.personalData}`}>
      <div className={`flex justify-between h-full ${style.prueba}`}>
        <div className='w-1/2'>
          <div className=''>
            <p className="text-red-500 font-bold mb-2">Numero de celular:</p>
            <p className={`rounded-md pl-3 mb-3 ${style.labelF}`}>
              9811548795
            </p>
          </div>
          <div className=''>
            <p className="text-red-500 font-bold mb-2">Numero de telefono:</p>
            <p className={`rounded-md mb-3 pl-3 ${style.labelF}`}>
              81812146
            </p>
          </div>
          <div className=''>
            <p className="text-red-500 font-bold mb-2">Correo electronico:</p>
            <p className={`rounded-md mb-3 pl-3 ${style.labelF}`}>prueba@prisma.com</p>
          </div>
          <div className=''>
            <p className="text-red-500 font-bold mb-2">Red social (Opcional):</p>
